...
BEGIN
  ...
  LOOP
    IF NOT EXISTS (
      ...
      VALUES
        (plan_record.plan_id, 'Fixtures', 'Fixtures', '#EF4444', TRUE, TRUE, 1),
        (plan_record.plan_id, 'Power', 'Power', '#F59E0B', TRUE, TRUE, 2),
        (plan_record.plan_id, 'Branch', 'Branch', '#10B981', TRUE, TRUE, 3),
        (plan_record.plan_id, 'Feeders', 'Feeders', '#3B82F6', TRUE, TRUE, 4),
        (plan_record.plan_id, 'Switchgear', 'Switchgear', '#8B5CF6', TRUE, TRUE, 5),
        (plan_record.plan_id, 'Equipment', 'Equipment', '#EC4899', TRUE, TRUE, 6),
        (plan_record.plan_id, 'Special Systems', 'Special Systems', '#06B6D4', TRUE, TRUE, 7);
