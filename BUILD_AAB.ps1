# TradeFlow AAB Build Script for Google Play
# This script builds the Android App Bundle for upload to Google Play Store

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  TradeFlow AAB Build for Google Play  " -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path "app.json")) {
    Write-Host "ERROR: app.json not found! Not in timeclock-mobile directory." -ForegroundColor Red
    exit 1
}
