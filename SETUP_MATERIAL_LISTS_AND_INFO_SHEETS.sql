-- ============================================
-- SETUP: Material Lists & Project Info Sheets
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_material_lists_project ON project_material_lists(project_id);
CREATE INDEX IF NOT EXISTS idx_material_list_items_list ON material_list_items(material_list_id);
CREATE INDEX IF NOT EXISTS idx_info_sheets_project ON project_info_sheets(project_id);
CREATE INDEX IF NOT EXISTS idx_file_attachments_project ON project_file_attachments(project_id);
CREATE INDEX IF NOT EXISTS idx_file_attachments_material_list ON project_file_attachments(material_list_id);
CREATE INDEX IF NOT EXISTS idx_file_attachments_info_sheet ON project_file_attachments(info_sheet_id);
